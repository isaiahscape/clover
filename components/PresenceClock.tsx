    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="presence-clock-grid">
      ...
      >
        ...
        <div className="text-left">
          ...
          <h4 className="text-base font-semibold text-foreground font-mono tracking-tight mt-0.5">
            {time || "12:00 AM"} <span className="text-xs text-muted-foreground font-normal">({seconds}s)</span>
          </h4>
        </div>
      </div>
      ...
      >
        ...
        <div className="text-left overflow-hidden w-full">
          ...
          <div className="text-xs font-medium text-foreground truncate mt-0.5" title={statusText}>
            {statusText}
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            <p className="text-xs font-medium text-foreground mt-0.5 truncate" title={codename}>
              {codename || "—"}
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="flex-shrink-0">
          {resendChecking ? (
            <span className="inline-flex h-2 w-2 rounded-full bg-muted-foreground animate-pulse" />
          ) : resendStatus?.connected ? (
